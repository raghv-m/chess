...
async function testGame() {
    ...
    const gameManager = new GameModeManager_1.GameModeManager(mockDb);
    // Test AI mode
    ...
    const moveResult = await gameManager.makeMove({ x: 4, y: 1, layer: 0 }, // from e2
    ...
    const localMoveResult = await gameManager.makeMove({ x: 4, y: 1, layer: 0 }, // from e2
    { x: 4, y: 3, layer: 0 } // to e4
    );
