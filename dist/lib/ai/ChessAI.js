...
class ChessAI {
    ...
    evaluatePositionalFactors(state) {
        let score = 0;
        // Center control
        const centerSquares = [
            { x: 3, y: 3 }, { x: 3, y: 4 },
    ...
    calculateKingSafetyScore(state, kingPos, color) {
        let score = 0;
        // Pawn shield
    ...
    countProtectingPieces(state, kingPos, color) {
        let count = 0;
